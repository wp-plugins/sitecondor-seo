<?php
  ...
  function recommendation_info_markup($recommendation, $index) {
    ?>
    ...
    <a id="hide-info-<?php echo $index; ?>" style="display:none;">Close 
      <span class='dashicons dashicons-arrow-up-alt2'></span>
    </a>

    <table id="info-<?php echo $index ?>" style="display:none;">
      <?php
      foreach( $arr as $urlIndex => $url) {
      ?>
        <tr>
              ...
              if ( !$options['apikey'] || !$options['job_id'] || !$options['schedule_id'] ) {
                ...
                if ( !is_array($jobs) ) {
                  ...
                  if ( count($successfully_completed_jobs) < 1 ) {
                    ...
                    $job = $successfully_completed_jobs[0];

                    $recommendations = sc_get_recommendations($options['apikey'], $job['_id']);
                    
                    if(!$recommendations || count($recommendations['list']) < 1) {
                      echo "<p><strong>You don't have any Recommendations at this time.</strong></p>";
                    } else {
                      echo "<p>The recommendations below are based on your report from " . substr( $job['createdAt'], 5, 2) . "/" . substr( $job['createdAt'], 8, 2 ) . "/" . substr( $job['createdAt'], 2, 2 ) . " and point out issues we recommend you review and fix on the site.</p>";        
                      ?>

                      <table class="widefat sc-table sc-recommendation-table"><tbody>
                        ...
                        foreach ( $recommendations['list'] as $index => $recommendation ) {
                          ...
                          if($recommendation['priority'] != $current_priority) {
                          ...
                          <?php
                            ...
                            switch($recommendation['type']) {
                              case 'not-found-internal':
                              ?>

                                <td>
                                  <h5>404 Not Found: Internal
                              ...
                              <?php
                                break;
                              case 'not-found-external':
                              ?>
                                <td>
                                  <h5>404 Not Found: External
                              ...
                              <?php  
                                break;                            
                              case 'redirect-internal-temporary':
                              ?>
                                <td>
                                  <h5>302 Internal Redirect
                              ...
                              <?php   
                                break;                           
                              case 'redirect-internal-permanent':
                              ?>
                                <td>
                                  <h5>301 Internal Redirect
                                  <a class="inline-tooltip" href="#" title="Eliminating redirects can improve user experience. Link to the destination page in the most direct manner possible.">
                                  <span data-code="f348" class="dashicons dashicons-info"></span></a>
                                  </h5>
                                  <?php echo $recommendation['info']['url']; ?>
                              ...
                              <?php  
                                break;                            
                              case 'redirect-external-temporary':
                              ?>
                                <td>
                                  <h5>302 External Redirect
                                  <a class="inline-tooltip" href="#" title="Eliminating redirects can improve user experience. Link to the destination page in the most direct manner possible.">
                                  <span data-code="f348" class="dashicons dashicons-info"></span></a>
                                  </h5>
                                  <?php echo $recommendation['info']['url']; ?>
                              ...
                              <?php   
                                break;                           
                              case 'redirect-external-permanent':
                              ?>
                                <td>
                                  <h5>301 External Redirect
                                  <a class="inline-tooltip" href="#" title="Eliminating redirects can improve user experience. Link to the destination page in the most direct manner possible.">
                                  <span data-code="f348" class="dashicons dashicons-info"></span></a>
                                  </h5>
                                  <?php echo $recommendation['info']['url']; ?>
                              ...
                              ?>
                                <td>
                                  <h5>Status Code: <?php echo $recommendation['info']['statusCode']; ?>
                              ...
                              ?>
                                <td>
                                  <h5>Image Missing Alt Attribute
